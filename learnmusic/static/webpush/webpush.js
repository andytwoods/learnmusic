...
(function () {
    ...
    // Early return if inside an iframe
  ...
  // Wait for DOMContentLoaded to ensure all DOM elements are available
  document.addEventListener('DOMContentLoaded', function() {
    // Initialize webpush functionality when DOM is fully loaded
    initializeWebPush();
  });
  ...
  function initializeWebPush() {
    ...
    if (!subBtn) {
      console.log('Webpush subscribe button not found in the DOM');
      return;
    }
  ...
  // Initialize the state of the push subscription
  ...
  function postSubscribeObj (statusType, subscription, callback) {
    ...
    // Check if subBtn exists before accessing its properties
    if (!subBtn) {
      console.log('Webpush subscribe button not found in postSubscribeObj');
      return;
    }
  ...
  // No need to return anything as we don't need to expose any public API
  return {};
}());
